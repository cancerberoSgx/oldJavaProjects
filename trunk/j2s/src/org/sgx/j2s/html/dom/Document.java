...
public class Document extends Node {
	 ...
	 * @j2sIgnore
	 */
	public org.w3c.dom.Document _doc;
	/**
	 * java only
	 * @j2sIgnore
	 */
	public Document(org.w3c.dom.Document _doc) {
		super(_doc);
		this._doc = (org.w3c.dom.Document) _doc;
	}
    ...
    public   NodeList getElementsByTagName(String tagname){
		 return new NodeList(_doc.getElementsByTagName(tagname));
    }
    /**
    ...
    public Element getElementById(String elementId){
    	return (Element) _p.getNodeFor(_doc.getElementById(elementId));
    }
    /**
    ...
    public Element createElement(String tagName) throws DOMException {
    	return (Element) _p.getNodeFor(_doc.createElement(tagName));
    }
//  /**
