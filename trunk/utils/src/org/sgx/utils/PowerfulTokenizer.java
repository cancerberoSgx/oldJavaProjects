...
public class PowerfulTokenizer implements Enumeration
{
	...
	public PowerfulTokenizer(String str, String sep)
	{
		...
		sDelim = sep;
		iLen = sDelim.length();
		oTokenizer = new StringTokenizer(str, sep, false);
	}
	...
	public String[]parse(String s, String sep) {
		PowerfulTokenizer oMT = new PowerfulTokenizer(s, sep);
		int iTokens = oMT.countTokens();
		String []out = new String[oMT.countTokens()];
	...
	public static void main(String[] args)
	{
		...
		String sIn = "mplayer -i \"/path/to/file\"";
