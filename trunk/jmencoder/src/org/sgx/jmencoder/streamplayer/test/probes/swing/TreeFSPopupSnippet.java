...
public class TreeFSPopupSnippet 
  extends JFrame 
{
...
// NEW
    ...
    { 
      ...
      {
                                m_tree.repaint();
        JOptionPane.showMessageDialog(TreeFSPopupSnippet.this, 
...
class FileNode
{
  ...
  public boolean expand(DefaultMutableTreeNode parent)
  {
    ...
    {
      FileNode nd = (FileNode)v.elementAt(i);
      IconData idata = new IconData(TreeFSPopupSnippet.ICON_FOLDER, 
        TreeFSPopupSnippet.ICON_EXPANDEDFOLDER, nd);
