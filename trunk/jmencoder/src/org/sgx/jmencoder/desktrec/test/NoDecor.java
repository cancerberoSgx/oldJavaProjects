...
public class NoDecor extends WindowAdapter implements ActionListener {
 ...
 protected static Image getFDImage() {
   java.net.URL imgURL = NoDecor.class.getResource("images/FD.jpg");
   if (imgURL != null) {
