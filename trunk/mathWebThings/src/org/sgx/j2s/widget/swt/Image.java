...
////
////	public Image(Composite parentWidget, int style) {
////		super(parentWidget, style);
//////		super();
////		init(parentWidget);		
////	}
//
...
//		if(type==TYPE_IMAGE){
//			InputStream io = Image.class.getClassLoader().getResourceAsStream(s);
...
//		_handler.setParent(((Image)parent)._handler);
//	}
//
//	@Override
