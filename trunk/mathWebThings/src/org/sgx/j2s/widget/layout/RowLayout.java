...
//
//import org.sgx.j2s.base.Rectangle;
//import org.sgx.j2s.widget.Widget;
//
///*
// * intento de adaptar un layout swt a j2s.widget
// */
...
// * children of a <code>Widget</code> by placing them either in 
// * horizontal rows or vertical columns within the parent <code>Widget</code>. 
// * <p>
...
//}
//
//protected Point computeSize (Widget widget, int wHint, int hHint, boolean flushCache) {
//	Point extent;
//	if (type == SWT.HORIZONTAL) {
//		extent = layoutHorizontal (widget, false, (wHint != SWT.DEFAULT) && wrap, wHint, flushCache);
//	} else {
//		extent = layoutVertical (widget, false, (hHint != SWT.DEFAULT) && wrap, hHint, flushCache);
//	}
...
//}
//
//Point computeSize (Widget control, boolean flushCache) {
...
//}
//
//protected boolean flushCache (Widget control) {
//	return true;
//}
//
//String getName () {
...
//}
//
//protected void layout (Widget widget, boolean flushCache) {
//	Rectangle clientArea = widget.getContentArea ();
//	if (type == SWT.HORIZONTAL) {
//		layoutHorizontal (widget, true, wrap, clientArea.width, flushCache);
//	} else {
//		layoutVertical (widget, true, wrap, clientArea.height, flushCache);
//	}
//}
//
//Point layoutHorizontal (Widget widget, boolean move, boolean wrap, int width, boolean flushCache) {
//	Widget [] children = widget.getChildren ();
//	int count = 0;
//	for (int i=0; i<children.length; i++) {
//		Widget control = children [i];
//		RowData data = (RowData) control.getLayoutData ();
...
//	if (move) {
//		Rectangle rect = widget.getContentArea ();
//		clientX = rect.x;
//		clientY = rect.y;
//	}
//	int [] wraps = null;
...
//}
//
//Point layoutVertical (Widget widget, boolean move, boolean wrap, int height, boolean flushCache) {
//	Widget [] children = widget.getChildren ();
//	int count = 0;
//	for (int i=0; i<children.length; i++) {
//		Widget control = children [i];
