...
public interface Editor<T>{
	...
	/**
	 * @return if null that mean that the value is not available. 
	 * use getLastError() . for implementors is usually having a string 
	 * attribute and assig an alert if the user input does not validate 
	 * (i.e parsing a number)
	 */
	public T getValue();
