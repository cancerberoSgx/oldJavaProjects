 ...
 *
 */
public class FontPanel1 extends JPanel {
...
//			jPanel.setLayout(new BoxLayout(getJPanel(), BoxLayout.X_AXIS));
	...
	private JComboBox getFontNameCombo() {
		if (fontNameCombo == null) {
			...
			fontNameCombo.setPreferredSize(new Dimension(200, 20));
	...
	private JComboBox getFontSizeCombo() {
		if (fontSizeCombo == null) {
			...
			fontSizeCombo.setSelectedIndex(5);
	...
	private JPanel getJPanel2() {
		if (jPanel2 == null) {
			...
			jPanel2.add(getFontStyleList(), new GridBagConstraints(1, 0, 2, 2, 1.0, 1.0, GridBagConstraints.SOUTH, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		}
		return jPanel2;
	}
