...
public class VideoConversionPanel extends JPanel {
	...
	private JCheckBox useMencoder = null;
	...
	private JPanel getJPanel2111() {
		if (jPanel2111 == null) {
			...
			jLabel111.setText("Use mencoder");
			jPanel2111 = new JPanel();
			jPanel2111.setLayout(new BoxLayout(getJPanel2111(), BoxLayout.X_AXIS));
			jPanel2111.add(getUseMencoder(), null);
	...
	public boolean getSelectedUseMencoder() {
		return useMencoder.isSelected();
	}
	...
	private JCheckBox getUseMencoder() {
		if (useMencoder == null) {
			useMencoder = new JCheckBox();
		}
		return useMencoder;
	}
