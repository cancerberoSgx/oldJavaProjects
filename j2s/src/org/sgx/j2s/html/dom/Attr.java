 ...
 * @j2sIgnore
 */
	public Attr(org.w3c.dom.Node _node) {
		super(_node);
	}
/**
 * @j2sIgnore
 */
	public String name;
	/**
	 * please use Element.get/setAttribute() for accessing attribute value
	 */
//	public String  value;
...
//    }
    ...
    public boolean getSpecified(){
    	return ((org.w3c.dom.Attr)_node).getSpecified();
    }
...
//    	return ((org.w3c.dom.Attr)_node).getValue();
//    }
//    /**
//     * On retrieval, the value of the attribute is returned as a string. 
//     * Character and general entity references are replaced with their 
...
//    	((org.w3c.dom.Attr)_node).setValue(value);
//    }
//
//    /**
