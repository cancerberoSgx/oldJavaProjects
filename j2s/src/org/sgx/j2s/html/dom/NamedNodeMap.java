...
public class NamedNodeMap {
	 ...
	 * @j2sIgnore
	 */
	private org.w3c.dom.NamedNodeMap _nodeMap;
/**
 * @j2sIgnore
 */
	public NamedNodeMap(org.w3c.dom.NamedNodeMap _nodeMap) {
    ...
    public Node item(int index){
    	return (_nodeMap!=null) ? (XMLParser.getInstance().getNodeFor(_nodeMap.item(index))) : (null);
    }
    ...
    public Node getNamedItem(String name) {
    	return (_nodeMap!=null) ? (XMLParser.getInstance().getNodeFor(_nodeMap.getNamedItem(name))) : (null); 
    }
