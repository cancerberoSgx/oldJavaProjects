...
/**
 * representación de las propiedades css que pertenecen al estilo de un widget
 * todos los valores de las properties son de tipo String. 
 * 
 * if a prop value is null, they wont be written to css code 
 * @author sgurin
 *
 *@j2sRequireImport java2js.morphs.datatypes.FloatMag, java.util.HashMap, java.util.Map, java2js.model.PropertyDesc, 
java2js.model.PropertyHaver, java2js.model.RangedMagnitudePropDesc, java2js.morphs.datatypes.Border, 
java2js.morphs.datatypes.Color
 */
public interface CssStyle  {
		
	
	//style related but not css properties
